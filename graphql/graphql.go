...
func (b *Block) EstimateGas(ctx context.Context, args struct {
	...
	return ethapi.DoEstimateGas(ctx, b.r.backend, args.Data, *b.numberOrHash, b.r.backend.RPCGasCap(), nil)
}
...
func (p *Pending) EstimateGas(ctx context.Context, args struct {
	...
	return ethapi.DoEstimateGas(ctx, p.r.backend, args.Data, latestBlockNr, p.r.backend.RPCGasCap(), nil)
}
